<template>
  <div>
    ...
    <div class="banner" :style="cover">
      <h1 class="banner-title">热点信息</h1>
    </div>
    <v-card class="blog-container" style="text-align: center;"><h1 class="h1time">定时更新</h1></v-card>
    <!-- 关于内容 -->
    <v-card >
      <iframe src="http://39.101.194.186/hot" scrolling="auto" frameborder="0" style="width: 100%;height: 900px;"></iframe>
    </v-card>
  </div>
</template>
